...
public class ProcMenuOptionShot2 {
	...
	public static void run() {
		loop:while(true) {
			...
			case "1":
				...
				KioskObj.basket.add(new Order(KioskObj.products.get(1),"strong"));
				break loop;
			case "2":
				System.out.println("연하게 선택됨. 이전 메뉴 이동");
				KioskObj.basket.add(new Order(KioskObj.products.get(1),"weak"));
				break loop;
			case "x":
